...
SRC_URI=""
EGIT_BRANCH=master-si-spill-fixes-v4
#EGIT_BRANCH=master
EGIT_REPO_URI="https://github.com/darkbasic/llvm.git"
...
src_unpack() {
	if use clang; then
		EGIT_BRANCH=master git-r3_fetch "https://github.com/darkbasic/compiler-rt.git"
		EGIT_BRANCH=master git-r3_fetch "https://github.com/darkbasic/clang.git"
		EGIT_BRANCH=master git-r3_fetch "https://github.com/darkbasic/clang-tools-extra.git"
	fi
	git-r3_fetch

	if use clang; then
		git-r3_checkout https://github.com/darkbasic/compiler-rt.git \
			"${S}"/projects/compiler-rt
		git-r3_checkout https://github.com/darkbasic/clang.git \
			"${S}"/tools/clang
		git-r3_checkout https://github.com/darkbasic/clang-tools-extra.git \
