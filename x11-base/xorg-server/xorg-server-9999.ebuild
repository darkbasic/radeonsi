...
EGIT_BRANCH=glamor-server
EGIT_REPO_URI="git://people.freedesktop.org/~keithp/xserver"
...
IUSE="${IUSE_SERVERS} ipv6 minimal nptl selinux +suid systemd tslib +udev unwind glamor"
...
DEPEND="${RDEPEND}
	...
	glamor? ( media-libs/libepoxy !x11-libs/glamor )
	dmx? (
